...
(defconst fpga-yosys-shell-commands
  '("abc" "abc9" "abc9_exe" "abc9_ops" "abc_new" "abc_ops_reintegrate"
    "abstract" "add" "aigmap" "alumacc" "anlogic_eqn" "anlogic_fixcarry"
    "arith_tree" "assertpmux" "async2sync" "attrmap" "attrmvcp" "autoname"
    "blackbox" "bmuxmap" "booth" "box_derive" "bufnorm" "bugpoint" "bwmuxmap"
    "cd" "cellmatch" "check" "check_mem" "chformal" "chparam" "chtype" "clean"
    "clean_zerowidth" "clk2fflogic" "clkbufmap" "clockgate" "connect"
    "connect_rpc" "connwrappers" "constmap" "coolrunner2_fixup"
    "coolrunner2_sop" "copy" "cutpoint" "debug" "delete" "deminout" "demuxmap"
    "design" "design_equal" "dffinit" "dfflegalize" "dfflibmap" "dffunmap"
    "dft_tag" "dump" "echo" "edgetypes" "efinix_fixcarry" "equiv_add"
    "equiv_induct" "equiv_make" "equiv_mark" "equiv_miter" "equiv_opt"
    "equiv_purge" "equiv_remove" "equiv_simple" "equiv_status" "equiv_struct"
    "eval" "example_dt" "exec" "expose" "extract" "extract_counter"
    "extract_fa" "extract_reduce" "extractinv" "flatten" "flowmap" "fmcombine"
    "fminit" "formalff" "freduce" "fsm" "fsm_detect" "fsm_expand" "fsm_export"
    "fsm_extract" "fsm_info" "fsm_map" "fsm_opt" "fsm_recode" "fst2tb"
    "future" "gatemate_foldinv" "glift" "greenpak4_dffinv" "help" "hierarchy"
    "hilomap" "history" "ice40_braminit" "ice40_dsp" "ice40_opt"
    "ice40_wrapcarry" "icell_liberty" "insbuf" "internal_stats" "iopadmap"
    "jny" "json" "keep_hierarchy" "lattice_dsp_nexus" "lattice_gsr" "libcache"
    "license" "linecoverage" "linux_perf" "log" "logger" "ls" "ltp" "lut2bmux"
    "lut2mux" "maccmap" "memory" "memory_bmux2rom" "memory_bram"
    "memory_collect" "memory_dff" "memory_libmap" "memory_map" "memory_memx"
    "memory_narrow" "memory_nordff" "memory_share" "memory_unpack"
    "microchip_dffopt" "microchip_dsp" "miter" "mutate" "muxcover" "muxpack"
    "nlutmap" "nx_carry" "onehot" "opensta" "opt" "opt_balance_tree"
    "opt_clean" "opt_demorgan" "opt_dff" "opt_expr" "opt_ffinv" "opt_hier"
    "opt_lut" "opt_lut_ins" "opt_mem" "opt_mem_feedback" "opt_mem_priority"
    "opt_mem_widen" "opt_merge" "opt_muxtree" "opt_reduce" "opt_share"
    "paramap" "peepopt" "plugin" "pmux2shiftx" "pmuxtree" "portarcs"
    "portlist" "prep" "printattrs" "proc" "proc_arst" "proc_clean" "proc_dff"
    "proc_dlatch" "proc_init" "proc_memwr" "proc_mux" "proc_prune"
    "proc_rmdead" "proc_rom" "qbfsat" "ql_bram_merge" "ql_bram_types"
    "ql_dsp_io_regs" "ql_dsp_macc" "ql_dsp_simd" "ql_ioff" "raise_error"
    "read" "read_aiger" "read_blif" "read_json" "read_liberty" "read_rtlil"
    "read_slang" "read_verilog" "read_verilog_file_list" "read_xaiger2"
    "recover_names" "rename" "rmports" "sat" "scatter" "scc" "scratchpad"
    "script" "sdc" "sdc_expand" "select" "setattr" "setenv" "setparam"
    "setundef" "share" "shell" "show" "shregmap" "sim" "simplemap"
    "slang_defaults" "slang_version" "sort" "splice" "splitcells" "splitnets"
    "sta" "stat" "submod" "supercover" "synth" "synth_achronix"
    "synth_analogdevices" "synth_anlogic" "synth_coolrunner2" "synth_easic"
    "synth_ecp5" "synth_efinix" "synth_fabulous" "synth_gatemate"
    "synth_gowin" "synth_greenpak4" "synth_ice40" "synth_intel"
    "synth_intel_alm" "synth_lattice" "synth_microchip" "synth_nanoxplore"
    "synth_nexus" "synth_quicklogic" "synth_sf2" "synth_xilinx" "synthprop"
    "tcl" "techmap" "tee" "test_abcloop" "test_autotb" "test_cell"
    "test_generic" "test_kogge_stone" "test_slangdiag" "test_slangexpr"
    "timeest" "torder" "trace" "tribuf" "uniquify" "verific"
    "verilog_defaults" "verilog_defines" "viz" "wbflip" "wrapcell" "wreduce"
    "write_aiger" "write_aiger2" "write_blif" "write_btor" "write_cxxrtl"
    "write_edif" "write_file" "write_firrtl" "write_functional_cxx"
    "write_functional_rosette" "write_functional_smt2" "write_intersynth"
    "write_jny" "write_json" "write_rtlil" "write_simplec" "write_smt2"
    "write_smv" "write_spice" "write_table" "write_verilog" "write_xaiger"
    "write_xaiger2" "xilinx_dffopt" "xilinx_dsp" "xilinx_srl" "xprop"
    "zinit"))
