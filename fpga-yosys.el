...
(defconst fpga-yosys-shell-commands
  '("abc" "abc9" "abc9_exe" "abc9_ops" "abc_new" "abstract" "add" "aigmap"
    "alumacc" "anlogic_eqn" "anlogic_fixcarry" "assertpmux" "async2sync"
    "attrmap" "attrmvcp" "autoname" "blackbox" "bmuxmap" "booth" "box_derive"
    "bufnorm" "bugpoint" "bwmuxmap" "cd" "cellmatch" "check" "chformal"
    "chparam" "chtype" "clean" "clean_zerowidth" "clk2fflogic" "clkbufmap"
    "clockgate" "connect" "connect_rpc" "connwrappers" "constmap"
    "coolrunner2_fixup" "coolrunner2_sop" "copy" "cover" "cutpoint" "debug"
    "delete" "deminout" "demuxmap" "design" "dffinit" "dfflegalize"
    "dfflibmap" "dffunmap" "dft_tag" "dump" "echo" "edgetypes"
    "efinix_fixcarry" "equiv_add" "equiv_induct" "equiv_make" "equiv_mark"
    "equiv_miter" "equiv_opt" "equiv_purge" "equiv_remove" "equiv_simple"
    "equiv_status" "equiv_struct" "eval" "example_dt" "exec" "expose"
    "extract" "extract_counter" "extract_fa" "extract_reduce" "extractinv"
    "flatten" "flowmap" "fmcombine" "fminit" "formalff" "freduce" "fsm"
    "fsm_detect" "fsm_expand" "fsm_export" "fsm_extract" "fsm_info" "fsm_map"
    "fsm_opt" "fsm_recode" "fst2tb" "future" "gatemate_foldinv" "ghdl" "glift"
    "greenpak4_dffinv" "help" "hierarchy" "hilomap" "history" "ice40_braminit"
    "ice40_dsp" "ice40_opt" "ice40_wrapcarry" "insbuf" "internal_stats"
    "iopadmap" "jny" "json" "keep_hierarchy" "lattice_gsr" "libcache"
    "license" "linecoverage" "log" "logger" "ls" "ltp" "lut2mux" "maccmap"
    "memory" "memory_bmux2rom" "memory_bram" "memory_collect" "memory_dff"
    "memory_libmap" "memory_map" "memory_memx" "memory_narrow" "memory_nordff"
    "memory_share" "memory_unpack" "microchip_dffopt" "microchip_dsp" "miter"
    "mutate" "muxcover" "muxpack" "nlutmap" "nx_carry" "onehot" "opt"
    ...
    "read_verilog" "read_verilog_file_lis" "read_xaiger2" "recover_names"
    "rename" "rmports" "sat" "scatter" "scc" "scratchpad" "script" "select"
    "setattr" "setenv" "setparam" "setundef" "share" "shell" "show" "shregmap"
    "sim" "simplemap" "splice" "splitcells" "splitnets" "sta" "stat" "submod"
    "supercover" "synth" "synth_achronix" "synth_anlogic" "synth_coolrunner2"
    "synth_easic" "synth_ecp5" "synth_efinix" "synth_fabulous"
    "synth_gatemate" "synth_gowin" "synth_greenpak4" "synth_ice40"
    "synth_intel" "synth_intel_alm" "synth_lattice" "synth_microchip"
    "synth_nanoxplore" "synth_nexus" "synth_quicklogic" "synth_sf2"
    "synth_xilinx" "synthprop" "tcl" "techmap" "tee" "test_abcloop"
    "test_autotb" "test_cell" "test_generic" "test_pmgen" "test_select"
    ...
    "write_functional_rose" "write_functional_smt2" "write_intersynth"
